...
print("The model above is the actual model that we are looking for even though"
	  " the p-value of third variable is slightly higher than our threshold.")
"""The model above is the actual model that we are looking for even though
	   the p-value of third variable is slightly higher than our threshold."""

# Let us now remove even the third independent variable and check the Adjusted RSquared error.
print("Let us now remove even the third independent variable and check the Adjusted RSquared error.")
X_opt = X[:, [0,3]]
estimation = sm.OLS(endog=y, exog=X_opt).fit()
print(estimation.summary())

#We can see that the Adjusted R-square error has decreasted. This is not good. We need to revert back to older model
#which still had the removed independent variable.
print("We can see that the Adjusted R-square error has decreasted. This is not good. We need to revert back to older model"
"which still had the removed independent variable.")